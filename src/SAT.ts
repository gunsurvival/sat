...
export class Circle extends Schema {
	...
	@type(Vector) offset: Vector;

	constructor(pos: Vector, r = 0) {
		super();
...
export class Polygon extends Schema {
	@type(Vector) pos: Vector;
	@type('number') angle = 0;
	@type(Vector) offset = new Vector();
	@type([Vector]) points = new Array<Vector>();
	calcPoints = new Array<Vector>();
	edges = new Array<Vector>();
	normals = new Array<Vector>();

	constructor(pos = new Vector(), points: Vector[] = []) {
		super();
		this.pos = pos;
		this.setPoints(points);
	}

	setPoints(points: Vector[]): this {
...
export class Box extends Schema {
	...
	constructor(pos: Vector = new Vector(), w = 0, h = 0) {
		super();
		this.pos = pos;
		this.w = w;
		this.h = h;
...
export function flattenPointsOn(points: Vector[], normal: Vector, result: number[]) {
...
export function voronoiRegion(line: Vector, point: Vector): number {
...
export function pointInCircle(p: Vector, c: Circle) {
...
export function pointInPolygon(p: Vector, poly: Polygon) {
...
export function testCircleCircle(a: Circle, b: Circle, response: Response | undefined = undefined) {
...
export function testPolygonCircle(polygon: Polygon, circle: Circle, response: Response | undefined = undefined) {
